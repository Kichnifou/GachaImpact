...
import { getBusinessDate, getNextBusinessResetAt } from '../src/domain/time/business-date.js';
...
describe('Europe/Paris business date', () => {
  ...
  it('returns the next Paris midnight as an absolute instant on both DST sides', () => {
    expect(getNextBusinessResetAt(new Date('2026-03-29T12:00:00.000Z'))).toEqual(new Date('2026-03-29T22:00:00.000Z'));
    expect(getNextBusinessResetAt(new Date('2026-10-25T12:00:00.000Z'))).toEqual(new Date('2026-10-25T23:00:00.000Z'));
  });
});
