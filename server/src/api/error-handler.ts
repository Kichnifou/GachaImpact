...
const businessStatusCodes: Readonly<Record<BusinessErrorCode, number>> = {
  ...
  SHOP_ITEM_UNAVAILABLE: 409,
  SHOP_QUANTITY_INVALID: 422,
  SHOP_WALLET_INSUFFICIENT: 409,
  SHOP_IDEMPOTENCY_CONFLICT: 409,
  SHOP_HISTORY_PAGE_INVALID: 400,
  SHOP_CATALOG_INVALID: 500,
  ...
  MODERATION_SELF_ROLE_FORBIDDEN: 403,
