...
const result = (playerId: string): ModerationStateDto => ({
  player: { id: playerId, displayName: playerId, elementKey: 'hydro', avatarAssetPath: null, level: 1, tester: false, rank: 'PLAYER' },
  permissions: { roles: ['ADMIN'], capabilities: { moderationAccess: true, communityModeration: true, selfResourceTools: true, selfGameplayTools: true, superTools: true, canSelectPlayers: true, canManageTesters: true } },
