...
import PlayerIdentityInline from './PlayerIdentityInline'
...
export type PlayerBrowserCandidate = Readonly<{ id: string; displayName: string; level: number; elementKey: ElementKey | null; avatarAssetPath?: string | null }>
