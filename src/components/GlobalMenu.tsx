...
function GlobalMenu({ preference, page, onPageChange, onNavigate, onActivities, onClose }: { preference: NavigationMenuPreferenceDto; page: number; onPageChange: (page: number) => void; onNavigate: (screen: ScreenId) => void; onActivities?: () => void; onClose: () => void }) {
