...
type Props = { gacha: CurrentGachaDto; compact?: boolean; showDetails?: boolean; onSetTarget: (id: string) => Promise<void>; onOpen?: () => void }

function BannerHero({ gacha, compact = false, showDetails = false, onSetTarget, onOpen }: Props) {
