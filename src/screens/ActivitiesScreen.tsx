...
function ActivitiesScreen(props: ActivitiesScreenProps) {
  ...
  if (screen === 'activities-event' && props.event && props.onLoadEvent && props.onJoinEvent && props.onAttemptEventGameA) return <EventScreen key={`${props.event.edition.id}:${props.event.businessDate}`} value={props.event} onLoad={props.onLoadEvent} onJoin={props.onJoinEvent} onAttempt={props.onAttemptEventGameA} onAttemptB={props.onAttemptEventGameB ?? (async () => { throw new Error('Jeu B indisponible.') })} />
