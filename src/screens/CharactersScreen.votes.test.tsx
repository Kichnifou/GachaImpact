...
describe('Catalogue community votes', () => {
  ...
  it('shows only eligible counters/actions and immediately replaces all CTAs after voting', async () => {
    ...
    expect(container.textContent).toContain('définitif')
    expect(container.textContent).toContain('21/09/2026 00:00')
    ...
    expect(container.textContent).toContain('Votre vote ✓')
