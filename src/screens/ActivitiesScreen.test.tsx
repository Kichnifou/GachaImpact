...
const eventAfterJoin: EventDto = { ...eventBeforeJoin, participation: { joined: true, joinedAt: '2026-09-15T12:00:00.000Z', points: 0 }, currency: { amount: '1' }, canJoin: false, gameA: { ...eventBeforeJoin.gameA, available: true, windows: [], canAttempt: false } }
...
describe('Activities shells', () => {
  ...
  it('keeps Event access before join and while Game A remains, then hides it after daily success', () => {
