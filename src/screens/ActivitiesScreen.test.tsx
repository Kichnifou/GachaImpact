...
describe('Activities shells', () => {
  ...
  it('shows Event access only while a real action remains and restores it from the next-day snapshot', () => {
    ...
    expect(completeCard.textContent).toContain('Énigme du jour disponible · 1 Jetons de Récolte')
    ...
    expect(expiredCard.textContent).toContain('Énigme du jour disponible · 1 Jetons de Récolte')
    ...
    expect(activity(bonusClaimed.container, 'Événement').querySelector('.daily-overview-action-slot')).toBeNull()
