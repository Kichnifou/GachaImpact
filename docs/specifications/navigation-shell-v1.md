...
La notification agrégée `trades / TRADES_PENDING / OPEN_TRADES` mène à cette surface. À l'ouverture, au focus, au retour visible et toutes les trois secondes visibles, les projections sont rafraîchies sans superposition. Le même snapshot autoritaire publie les particules dans la sidebar et le cache Sac, y compris après acceptation distante ; la sortie arrête ce polling. Une mutation attend la réponse, rafraîchit immédiatement et conserve sa clé en cas de réponse ambiguë.
