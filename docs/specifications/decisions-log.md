...
- `VALIDÉ R736` — Langage visuel commun des cartes personnage : trois variantes sont distinguées. La variante **Showcase / Team**, dont l'écran Équipe est la référence anatomique, place le badge élémentaire en haut à gauche, une éventuelle métadonnée contextuelle en haut à droite, un portrait contenu dans une zone clairement délimitée, puis le nom, les étoiles et, si le contexte le prévoit, une ligne Niveau à gauche / Cx à droite. Cette anatomie est réellement partagée par l'écran Équipe, l'Équipe active de la sidebar et le picker Invocation 5★, avec des gabarits adaptés. La variante **Collection compacte**, référencée par Box / Personnages, est conçue pour la densité et ses cartes ne doivent pas être agrandies. La variante **Featured 4★**, inspirée de la collection compacte, est utilisée uniquement dans le hero Invocation sélectionné.
- `VALIDÉ R737` — Présentation des six 4★ de bannière : ils sont absents de toute sélection ou changement de cible 5★, y compris la première sélection sans cible ; aucun conteneur ni espace ne leur est réservé dans le picker. Ils restent affichés **uniquement dans le hero Invocation normal lorsqu'une cible est sélectionnée**, sur une seule ligne de six, desktop comme mobile. Leur variante Box-like affiche badge élémentaire, portrait prioritaire `iconPath`, nom et `★★★★`, sans Niveau, constellation, rôle, type, arme ni région.
