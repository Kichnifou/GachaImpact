...
- `VALIDÉ R769` — Un Pull reste exécuté et persisté immédiatement par le serveur, mais l’affichage global Resources/Gacha conserve son snapshot pré-Pull tant que sa présentation Invocation est volontairement active. Un x1 publie l’état post-Pull à la fermeture du résultat ; un x10 le publie dès l’ouverture du récapitulatif, y compris via `Passer`. Quitter Invocation abandonne la présentation et publie l’état dès qu’il est disponible : immédiatement si la réponse est prête, sinon à son arrivée, sans animation rejouée ni navigation forcée. L’intention pending reste protégée au-dessus de l’écran afin qu’un aller-retour ne permette ni second Pull ni changement de cible. Une déconnexion abandonne puis invalide la présentation frontend avant le sign-out ; un changement de session invalide aussi l’état et l’intention de retry précédents, et toute réponse tardive de l’ancien utilisateur est ignorée côté présentation sans annuler l’opération serveur autoritative. Un reload repart de l’état serveur autoritatif sans replay.
