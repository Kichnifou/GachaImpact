...
- `VALIDÉ R736` — Langage visuel commun des cartes personnage : les contextes affichant un portrait partagent un cadre net, une teinte et une bordure liées à l'élément, un symbole élémentaire en haut à gauche, un portrait propre, puis le nom et la rareté selon le contexte. Le grand écran Équipe est déjà validé et n'est pas redesigné : seul son symbole élémentaire passe en haut à gauche. L'Équipe active de la sidebar reprend ce langage sous forme compacte sans niveau, rôle, constellation ni bouton. Les variantes compactes Box / Personnages restent inchangées en taille et composition et servent de référence de netteté. Le picker 5★ constitue une variante intermédiaire ; les Featured 4★ une variante compacte de bannière.
- `VALIDÉ R737` — Présentation des six 4★ de bannière : sur desktop, le bandeau/footer dédié et le texte `Personnages 4★` disparaissent ; les six cartes compactes occupent l'espace libre bas-gauche du hero sélectionné et du picker. Chaque carte utilise `iconPath` en priorité, un badge élémentaire en haut à gauche, le nom, `★★★★`, une teinte et une bordure élémentaires, sans arme ni région. Sur mobile, elles restent dans une section séparée du flux, en grille 3×2 en portrait ou dans une disposition paysage compacte appropriée, avec le même langage visuel et sans label.
- `VALIDÉ R738` — Téléphone paysage : les panneaux secondaires joueur restent empilés verticalement, comme en portrait, dans l'ordre Particules → Équipe → Objectif → Daily Reward → Chat, avec scroll naturel. Les adaptations paysage internes à la bannière restent autorisées.
