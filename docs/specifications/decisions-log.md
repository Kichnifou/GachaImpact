...
- `VALIDÉ R820` — Quotidiennes possède `Aperçu | Roue | Défi`. Aperçu n’utilise que la Récompense quotidienne et la Roue réelles ; Roue réutilise sa logique existante et quitte l’Accueil. Défi remplace l’intitulé player-facing de l’ancienne mission quotidienne payante, reste indisponible sans service complet et sort de la Boutique visible.
