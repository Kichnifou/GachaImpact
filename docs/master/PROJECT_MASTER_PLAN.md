...
Version : Missions permanentes — Lots 1 à 3 validés publiquement ; correctif responsive Boutique approuvé et promu, à validation publique
Date : 2026-09-25
Statut : LOTS 1 À 3 ET PAGINATION/LOADERS PROMUS ET VALIDÉS PUBLIQUEMENT ; BOOTSTRAP STABLE ET PUBLIQUEMENT ACCEPTABLE AVEC LATENCE RÉSIDUELLE NON BLOQUANTE ; CORRECTIF RESPONSIVE BOUTIQUE `7106f39` APPROUVÉ ET PROMU, NON ENCORE VALIDÉ PUBLIQUEMENT
...
- **Domaine actif : Missions permanentes B/A/S/Z — Lots 1 à 3 promus et validés publiquement.** Le Lot 3 raccorde Expedition, Combat quotidien et Social/cœurs, dont les métriques Z Amitié parfaite et victoires manuelles, dans leurs transactions propriétaires : tous les producteurs autoritatifs du catalogue permanent B/A/S/Z sont physiquement raccordés et smoke-testés publiquement. Restent non implémentés la route/API Missions player-facing finale, l’écran Missions B/A/S/Z, `!mission`, Missions sur Profil, la confidentialité Missions UI, les notifications de complétion Missions player-facing, Twitch et la migration legacy R328.
...
- **Correctif responsive Boutique `7106f39` approuvé et promu, non encore validé publiquement.** Quantité et probabilités occupent une zone d’options commune ; prix, disponibilité et bouton partagent ensuite le même footer, sans réserve fixe de 150 px. Le Ticket reste à 150 000 Moras, probabilités et achat sont inchangés. Les contrôles Chrome locaux réussissent à 2560×1440, 1920×1080 et 1536×864 ; la validation visuelle publique après déploiement reste requise.
- **Contrôles des candidats approuvés.** Le Lot 3 réussit frontend 796/796 sur 87 fichiers, backend 396/396 sur 56 fichiers et les suites PostgreSQL Missions 11/11, Expedition 11/11, Combat 9/9, Amitié 16/16 et Social 8/8. Le correctif Boutique porte le frontend à 797/797 sur 87 fichiers et réussit build, typecheck, lint et diff-check ; le lint conserve uniquement les deux avertissements préexistants de `ContestScreen`. Prisma reste à 42 migrations suivies et appliquées, sans 043.
...
- Domaine actif : **MISSIONS PERMANENTES B / A / S / Z — LOTS 1 À 3 PROMUS ET VALIDÉS PUBLIQUEMENT**. Pagination/loaders sont validés publiquement, le bootstrap est stable et publiquement acceptable avec une latence résiduelle non bloquante, et tous les producteurs autoritatifs B/A/S/Z sont raccordés. Aucune migration 043 n’est créée. Le correctif responsive Boutique `7106f39` est approuvé et promu, sans validation publique encore acquise.
- Prochaine étape exacte : **vérification post-promotion ChatGPT** : confirmer `main == review`, Cloudflare Pages, Railway, `Application ready` et `/health`. Puis le propriétaire validera le responsive Boutique réel à 2560×1440 et 1920×1080 : bouton Ticket entièrement visible, prix Ticket/Primogemmes harmonisés et boutons Acheter alignés. Après cette validation seulement, reprendre Missions selon la roadmap. Restent non implémentés : route/API et écran Missions B/A/S/Z, `!mission`, Missions sur Profil, confidentialité Missions UI, notifications player-facing, Twitch et migration legacy R328. `PAID_INFRA_APPROVED = false`.
