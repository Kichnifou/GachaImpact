...
Version : Missions permanentes — Lot 2 promu, validation publique à venir
Date : 2026-09-24
Statut : LOT 1 PROMU ET VALIDÉ PUBLIQUEMENT ; LOT 2 APPROUVÉ PAR REVIEW INDÉPENDANTE ET PROMU SUR `main`, NON ENCORE VALIDÉ PUBLIQUEMENT
...
- **Domaine actif : Missions permanentes B/A/S/Z — Lot 2 approuvé par review indépendante et promu sur `main`, validation publique à venir.** Chat/XP, Pulls Gacha, possessions 4★/5★, C6 Pull/Stella, niveau Player, Moras gagnées, particules principales générées et intérêts Banque sont raccordés dans leurs transactions propriétaires. Expedition, Combat et Social/cœurs restent explicitement au Lot 3 non commencé ; aucun écran/API final, `!mission`, Profil, notification player-facing, Twitch ou import legacy n’est ajouté.
...
- **Contrôles du Lot 2 approuvé et promu.** La review indépendante a approuvé les commits fonctionnels et leur correctif Banque. Backend 394/394, PostgreSQL Missions 11/11, Chat 27/27, Gacha 23/23, Stella 6/6 et Banque 9/9 ; typecheck, build serveur, lint et statut Prisma réussissent. Le lint conserve uniquement les deux avertissements préexistants de `ContestScreen`. Avant promotion, DEV contient 10 Players, 10 états et 310 progressions, avec 0 complétion, 0 progression/baseline/carried non nul, 0 opération/récompense/catch-up Mission, 0 mouvement Mission et 0 marqueur R301 ; aucun compte Banque n’a de jour ou d’intérêt positif à régulariser au 24 septembre 2026. Aucun vrai Player DEV n’a été crédité ou rattrapé.
...
- Domaine actif : **MISSIONS PERMANENTES B / A / S / Z — LOT 2 PROMU SUR `main`, NON ENCORE VALIDÉ PUBLIQUEMENT**. Le Lot 1 reste validé publiquement ; la migration 042 est présente sur `main` et déjà appliquée/suivie sur DEV. Le Lot 3 n’est pas commencé.
- Prochaine étape exacte : **vérification ChatGPT de la promotion réelle** — confirmer `main == review`, Cloudflare Pages, Railway, le log `Application ready` et `/health`, puis produire la checklist publique Lot 2 fondée sur le diff promu. Ne pas déclarer ces preuves ni la validation publique Lot 2 avant leur contrôle. Restent au Lot 3 : Expedition, Combat, Social/cœurs et leur restitution spécifique. Restent aux lots ultérieurs : route/UI Missions, `!mission`, Profil, notifications player-facing, Twitch et reprise legacy R328. `PAID_INFRA_APPROVED = false`.
