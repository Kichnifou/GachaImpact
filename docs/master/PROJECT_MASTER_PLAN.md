...
Version : Chat global promu ; dernier micro-polish visuel promu, retest public à faire ; MP encore non physique
Date : 2026-09-22
Statut : CHAT GLOBAL PRESQUE VALIDÉ ; DERNIER MICRO-POLISH VISUEL PROMU, VÉRIFICATIONS PUBLIQUES ET VALIDATION FINALE EN ATTENTE
...
- Le premier lot Chat global player-facing, le lot réactivité/UX, le mini-lot final de polish, le dernier lot UX Composer et son micro-correctif de couleur sont **implémentés, testés, reviewés indépendamment et promus sur `main`**. Le test public du précédent HEAD `33241276048d6fdb45a7c0933a8f612f46d812bd` a confirmé la couleur des pseudos par Élément, le chevron intégré, la police restaurée, l'opacité du composer étendu et les autres comportements déjà validés. Il a révélé deux derniers écarts visuels : composer à légèrement rehausser avec un cadre bleuté arrondi renforcé au focus et sans espace fin supérieur, et pseudos PLAYER à ramener à 11 px comme `GachaImpact`. Le micro-polish `a86d1ebcd971f8a3b5139f2ec838fb1933ed03f2` les implémente, ses tests sont réussis et sa review indépendante est approuvée ; il est promu sur `main`. Cloudflare, Railway et le healthcheck du nouveau HEAD restent à vérifier, puis le retest public final reste à faire par Axel. Le Chat global est **presque validé**, sans clôture publique définitive ; les MP restent non physiques. Twitch, Realtime/WebSocket/SSE demeurent absents ; `PAID_INFRA_APPROVED = false`. La conversation Codex actuelle continue en CONTINUITÉ.
