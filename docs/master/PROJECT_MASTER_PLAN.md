...
Version : Clôture Batch C — Échanges de particules V1, candidat review
Date : 2026-09-21
Statut : BATCH C VALIDÉ PUBLIQUEMENT ; ÉCHANGES ET MICROFIX NOUVEL AMI CANDIDATS REVIEW, NON PROMUS
...
- Référence publique courante : `1080ad6ab68d48468dd877e094c82bc3c0b3da25`, déployé publiquement et validé par le propriétaire. Batch C / Social est clôturé : Amitié, polish Social/Profil, feedback persistant à travers recherche/filtres/tri, notifications, Menu Amis et refresh sont validés. Le seul complément demandé, archivage de « Nouvel ami » au clic, appartient au nouveau candidat et n'est pas encore publiquement validé. Batch B et Batch A restent promus ; Noël naturel reste à observer en décembre.
...
- Domaine actif : **Échanges de particules V1**, implémentation des décisions R5–R53 existantes, candidat sur review. API personnelle, écran réel, accès Menu/Sac, réservation expéditeur, transfert X/X neutre statistiquement, réconciliation, expiration Paris et notification agrégée sont physiques. Aucune nouvelle décision Rxxx.
...
- **Prochaine étape immédiate : review indépendante du candidat Échanges + microfix Nouvel ami sur `review`.** Après approbation seulement : mission dédiée de promotion main, déploiement et validation publique des échanges. Le domaine suivant sera **Chat global + messages privés**, conformément à [implementation-order-v1.md](../roadmap/implementation-order-v1.md). R633/R634 restent différées vers Historique global.
...
## Checkpoint candidat — Échanges de particules V1, 2026-09-21
