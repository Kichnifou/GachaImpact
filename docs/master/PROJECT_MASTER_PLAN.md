...
- Le déploiement et le test public de Batch C ont confirmé demandes, acceptation, amitié, cœurs, Quotidiennes et retrait/réajout. Le retour a identifié des défauts ciblés d'alignement, de filtres, de notification, de rafraîchissement et d'actions contextuelles ; les candidats `f3f7624669f14582939cb42dad7f90e4c17f6dbf`, `42a137b` puis `d9d84bd` sur `review` les corrigent. Aucune action Railway/Cloudflare dans ce lot ; `PAID_INFRA_APPROVED = false`.
- Correctifs post-test public : Social conserve **Amis / Demandes / Joueurs** avec colonnes stables, filtre relationnel serveur, demandes reçues prioritaires et surlignées, feedback temporaire cloisonné et bouton global explicite. Profil et Joueurs connectés consomment le même contrôleur Amitié, se synchronisent rapidement lorsqu'ils sont visibles et exposent les actions contextuelles après chargement du snapshot. Une demande crée une notification existante typée vers Demandes, résolue avec la demande ; aucun cœur ne notifie.
...
- Commits fonctionnels `f3f7624669f14582939cb42dad7f90e4c17f6dbf`, `42a137b` puis `d9d84bd`, parents `ebb4c2e7f8f76053a7f2a8cb8f7f57e2af055660`, `f3f7624669f14582939cb42dad7f90e4c17f6dbf` puis `d8905e5`. Le lot part du checkpoint promu et testé publiquement où `origin/main == origin/review`, sans rebase, migration, action DB publique, déploiement ni push `main`.
