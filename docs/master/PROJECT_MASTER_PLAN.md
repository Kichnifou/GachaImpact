...
- Après Batch C : 1. échanges de particules ; 2. Chat global + MP ; 3. suite de [implementation-order-v1.md](../roadmap/implementation-order-v1.md). R633/R634 restent reportées vers Historique global. Lire aussi [le workflow](../process/implementation-workflow.md), [l'architecture Social](../architecture/backend-architecture-v1.md#social-foundations) et [la navigation](../specifications/navigation-shell-v1.md). Les checkpoints ci-dessous restent des preuves historiques.
