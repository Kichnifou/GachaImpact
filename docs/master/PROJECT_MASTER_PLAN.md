...
Version : validations publiques Chat/MP, fermeture éditeur et signalement MP candidats sur review
Date : 2026-09-24
Statut : R894/R897/R515 VALIDÉS PUBLIQUEMENT, R509/R510/R517 CANDIDATES REVIEW
...
- **MP avancés — R504/R513/R514 validés publiquement.** Actions hover/tactile, édition Enter/Ctrl/Meta+Enter/IME/outside/Escape, suppression avec fermeture immédiate de sa confirmation, restauration, statuts, accusés Lu et scroll éditeur sont acquis. Le seul micro-polish candidat ferme désormais l'éditeur et affiche la bulle optimistic avant d'attendre le réseau après Entrée ou Sauvegarder ; il reste à revalider. La fenêtre/purge R504 reste strictement inchangée.
...
- Le lot Chat player-facing est validé publiquement pour R890 à R897 dans leur état révisé. R504/R513/R514 et R515 sont validées publiquement ; seule la fermeture immédiate de l'éditeur après validation appartient au nouveau candidat à revalider.
...
- Domaine actif : **candidat review du micro-polish éditeur et du signalement/modération privée R509/R510/R517**.
- Prochaine étape exacte : **review indépendante ChatGPT**, puis test public propriétaire seulement après promotion dédiée explicitement autorisée. R509/R510/R517 ne sont pas déclarées publiquement validées. Médias, `!mp`, sanctions, Twitch et Realtime/WebSocket/SSE restent reportés. `PAID_INFRA_APPROVED = false`.
