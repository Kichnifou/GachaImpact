...
- Référence publique courante : `41522d5faf63b176647df3f101b8e14593805cf0`, promotion main vérifiée par fetch ; déploiements Railway/Cloudflare et première validation publique propriétaire rapportés dans la mission. Les corrections Échanges jusqu'à `b97929693e59d8abb430efef712de6e7d47e4cd4` sont reviewées et approuvées pour `main`, sans être encore revalidées publiquement. Le microfix « Nouvel ami » est promu ; sa validation publique spécifique n'est pas explicitement confirmée. Batch C / Social demeure validé ; Noël naturel reste à observer en décembre.
...
- Domaine actif : **promotion et nouvelle validation publique Échanges**, avant clôture. Les règles économiques R5–R53 sont conservées ; le candidat reviewé traite synchronisation, lectures redondantes, accès UI, présentation Event et procédures opératoires.
...
- Aucun déploiement Railway/Cloudflare n'est encore vérifié pour les corrections approuvées ; leur promotion dédiée est autorisée. `PAID_INFRA_APPROVED = false`. La validation technique locale des échanges ne vaut pas test public du propriétaire.
...
- La promotion dédiée du candidat approuvé est autorisée dans cette mission ; après promotion, vérifier les déploiements puis réaliser un nouveau test public propriétaire. **Chat global + messages privés** ne démarre qu'après clôture publique des Échanges et du polish courant, conformément à [implementation-order-v1.md](../roadmap/implementation-order-v1.md). R633/R634 restent différées vers Historique global.
...
- Chaîne complète du candidat approuvée par la review indépendante ChatGPT jusqu'à `b97929693e59d8abb430efef712de6e7d47e4cd4` : `7757d4b62af76702ad9e097c5ab6fb1f22d2e18d` (serveur, parent baseline) → `a4e3dbdab9c42d90771a0371818883a6f9d95e3c` (frontend) → `ddc86d2eab9da7fe3826a56f705357546b65449f` (checkpoint) → `4b371a53ae2d813536c7dfedf9543473194988dd` (réactivité) → `b97929693e59d8abb430efef712de6e7d47e4cd4` (documentation). La présente mission de promotion est autorisée ; la version corrigée reste à tester publiquement après déploiement.
