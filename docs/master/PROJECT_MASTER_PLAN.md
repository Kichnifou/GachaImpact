...
Version : Missions permanentes — Lot 5, R898 MP et sécurisation des fins d'envoi promus, en attente de validation publique
Date : 2026-09-25
Statut : LOTS MISSIONS 1 À 4 PROMUS ET VALIDÉS PUBLIQUEMENT ; LOT 5 `!mission` / PROFIL / PRIVACY / POLISH ÉCRAN, R898 MP ET SÉCURISATION DES FINS D'ENVOI APPROUVÉS ET PROMUS, NON ENCORE VALIDÉS PUBLIQUEMENT ; BOOTSTRAP STABLE ET PUBLIQUEMENT ACCEPTABLE AVEC LATENCE RÉSIDUELLE NON BLOQUANTE ; CORRECTIF RESPONSIVE BOUTIQUE `7106f39` VALIDÉ PUBLIQUEMENT
...
- **Domaine actif : Missions permanentes B/A/S/Z — Lot 5 approuvé et promu, test public à venir.** Les Lots 1 à 4 sont promus et validés publiquement, et tous les producteurs autoritatifs du catalogue permanent sont raccordés. Le Lot 5 active `!mission` dans le Chat interne, ajoute Missions au Profil avec consommation réelle de Privacy `MISSIONS`, et partage le polish premier rang incomplet / non-terminées d'abord entre les deux écrans. Restent non implémentés les notifications de complétion player-facing, Twitch et la migration legacy R328.
- **R898 MP approuvée et promue, non encore validée publiquement.** La migration additive 043, présente sur `main` et appliquée sur DEV, porte les réponses persistantes dans une même conversation ; liste, fil récent, historique, recherche et preuves de signalement projettent leur contexte selon le contrat dynamique/figé. Le composer restaure focus et caret après succès ou échec sans voler un focus volontaire, et Répondre depuis l'Historique revient au fil récent.
...
- Le cycle Chat/MP antérieur est **CLÔTURÉ PUBLIQUEMENT** : R890–R897 et R504–R517 sont acquis. R898 et la sécurisation des fins d'envoi MP sont approuvées et promues, sans validation publique à ce stade ; elles ne remettent pas en cause ces acquis.
...
- Domaine actif : **MISSIONS PERMANENTES B / A / S / Z — LOT 5 ET DEUX CORRECTIFS MP APPROUVÉS ET PROMUS, EN ATTENTE DE VALIDATION PUBLIQUE**. Les Lots 1 à 4, pagination/loaders et le correctif responsive Boutique `7106f39` sont validés publiquement ; le bootstrap demeure stable et publiquement acceptable avec sa latence résiduelle non bloquante. `!mission`, Profil Missions et Privacy `MISSIONS` restent dans leur commit Lot 5 intact. La migration 043 appartient seulement au premier correctif MP.
- Prochaine étape exacte : **vérification post-promotion ChatGPT de `main == review`, Cloudflare Pages, Railway et `/health`, puis test public du Lot 5 Missions et des deux correctifs MP**. Restent non implémentés : notifications Missions player-facing, Twitch et migration legacy R328. `PAID_INFRA_APPROVED = false`.
