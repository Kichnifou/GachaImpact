...
Version : dernier polish Chat/MP — preview condensé, menu de liste et suppression des dossiers
Date : 2026-09-24
Statut : CHAT/MP PUBLIC VALIDÉ, RÉVISION R509 ET SUPPRESSION DE DOSSIER CANDIDATES REVIEW
...
- **R509/R510/R517 — socle validé publiquement, révision candidate sur review.** Signalement depuis fil live/R515, création du dossier, absence de notification immédiate, accès privé Communauté, absence de free-browse et snapshot gelé sont acquis. Le candidat montre au reporter seulement précédent/cible/suivant et l'informe du contexte plus large ; fingerprint, stale et preuve stockée restent sur 10/1/10.
- **Dernier polish Chat/MP candidat.** La liste Conversations/Archives gagne le menu `⋯` partagé avec le header sans lecture implicite ; le feedback de succès du report dure exactement trois secondes. MODERATOR/ADMIN peuvent supprimer après confirmation le seul dossier `direct_message_reports`, avec audit sans contenu privé ; MP, conversation, notifications, blocages et amitiés sont inchangés. Les curseurs Communauté enabled/disabled sont explicites.
...
- Domaine actif : **dernier polish Chat/MP candidat sur review : révision R509, menu `⋯` de liste et suppression des dossiers de signalement**.
- Prochaine étape exacte : **review indépendante, promotion dédiée, déploiements vérifiés puis validation publique ciblée**. Après cette validation, le cycle Chat/MP actuel peut être clôturé et un nouveau domaine choisi par le propriétaire depuis le Master/roadmap. Restent explicitement reportés : médias/pièces jointes/GIF, `!mp`, Twitch, Realtime/WebSocket/SSE, sanctions/avertissements après signalement, réponses privées de commandes et annonces globales automatiques/polish transverse futur. Aucun domaine suivant n'est choisi ici. `PAID_INFRA_APPROVED = false`.
