...
- **Chat global — VALIDÉ PUBLIQUEMENT ET CLÔTURÉ.** Le HEAD public final `68b8adc3bece298fe3f1e4be10a358860c563eba`, dont le dernier micro-polish fonctionnel est `b7d2774d45fe8400347c02dd25176624596a2c35`, a été validé explicitement par Axel : chevron d'envoi repositionné, texte/placeholder du composer repositionnés et séparateur sous Joueurs connectés sont acquis, comme le reste du cycle player-facing. ChatGPT a vérifié `main == review`, divergence `0 / 0`, Cloudflare Pages `SUCCESS`, Railway `SUCCESS`, `Application ready` et `/health` HTTP 200. Les erreurs HTTP transitoires observées pendant certains redémarrages Railway se sont stabilisées et ne constituent pas un défaut produit ouvert. Aucun correctif Chat global player-facing ne reste ouvert. Twitch, Realtime/WebSocket/SSE demeurent absents.
