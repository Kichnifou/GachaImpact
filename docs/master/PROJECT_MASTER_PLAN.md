...
Version : correctif R897 et finition des mutations MP sur review
Date : 2026-09-23
Statut : CORRECTIF R897/MP SUR REVIEW, VALIDATION PUBLIQUE CIBLÉE EN ATTENTE
...
- Domaine actif : **validation publique ciblée du correctif R897/MP publié sur `review`**, sans promotion implicite vers `main`.
- Prochaine étape exacte : **après déploiement/promotion explicitement autorisés, Axel teste la rafale Chat 1/2/3 et le verrou lent, puis les micro-ajustements R896 et l'ergonomie R504/R513/R514**. R891 et R895 ne sont pas rouvertes. Historique complet R515, recherche/date dans l'historique, signalement/admin MP, médias, `!mp`, Twitch et Realtime/WebSocket/SSE restent reportés. `PAID_INFRA_APPROVED = false`.
