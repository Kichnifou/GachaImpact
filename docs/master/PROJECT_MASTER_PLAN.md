...
Version : Classements et Historique validés publiquement sur le plan fonctionnel ; R912, Apparence et polish Menu/Event approuvés en review indépendante et promus
Date : 2026-09-26
Statut : R907, CLASSEMENTS ET HISTORIQUE GLOBAL VALIDÉS PUBLIQUEMENT SUR LE PLAN FONCTIONNEL ; R912, APPARENCE ET POLISH MENU/EVENT PROMUS APRÈS REVIEW INDÉPENDANTE ; VALIDATION PUBLIQUE DES NOUVEAUTÉS EN ATTENTE ; PROCHAINE ROTATION R911 À OBSERVER
...
- Domaine actif : **checkpoint R912, Apparence et Menu/Event promu sur `main` après review indépendante**, en attente de vérification des déploiements et de validation publique des nouveautés. Classements et Historique restent validés publiquement sur le plan fonctionnel ; le style R912 attend sa revalidation visuelle publique. R911 reste à observer lors d'une future rotation naturelle. DEV compte **47 migrations Prisma**, dont 045 à 047 pour Apparence.
- Prochaine étape exacte : **vérifier les déploiements Railway/Cloudflare et le healthcheck, puis faire revalider publiquement R912 et Menu/Event et tester publiquement Apparence avec Axel**. TwitchIdentity reste l'étape suivante de roadmap et n'est pas commencée. Restent non implémentés : notifications Missions player-facing, Twitch et migration legacy R328. `PAID_INFRA_APPROVED = false`.
