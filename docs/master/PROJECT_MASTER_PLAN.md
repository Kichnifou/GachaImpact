...
Version : micro-corrections finales et R515 Historique complet MP candidats sur review
Date : 2026-09-24
Statut : DEUX LOTS CANDIDATS SUR REVIEW, R515 EN ATTENTE DE REVIEW INDÉPENDANTE
...
- **Lot A candidat sur `review`.** R894 fixe désormais le verrou long à exactement trois secondes après M3, frontend et backend ; R897 sépare ce verrou visuel de la sécurité transport, réactive automatiquement le composer et restaure focus/caret sans voler un focus volontaire. R891 et R895 restent **VALIDÉES PUBLIQUEMENT** et ne changent pas. Les versions révisées R894/R897 restent **À REVALIDER PUBLIQUEMENT** après déploiement.
...
- Domaine actif : **finaliser les contrôles du candidat R515 puis publier son second commit dédié sur `review`**, sans promotion `main`.
- Prochaine étape exacte : **review indépendante ChatGPT des commits A et B, puis seulement déploiement/validation publique décidés par le propriétaire**. Axel revalidera alors R894/R897 et les nouvelles interactions MP ; R515 reste candidate tant que cette revue et le test public n'ont pas eu lieu. R891, R895 et R896 ne sont pas rouvertes. Signalement/admin MP, médias, `!mp`, Twitch et Realtime/WebSocket/SSE restent reportés. `PAID_INFRA_APPROVED = false`.
