...
- Domaine actif : **Apparence / avatars / titres, correctif candidat `review`**. R912 est publié sur `review` et approuvé par review indépendante ; Classements et Historique sont validés publiquement sur le plan fonctionnel, avec validation publique visuelle de R912 en attente. R911 reste à observer lors d'une future rotation naturelle. DEV compte **46 migrations Prisma**, dont 045 et 046 pour Apparence.
