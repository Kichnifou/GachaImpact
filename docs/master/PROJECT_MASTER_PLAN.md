...
- Référence publique actuelle : `origin/main = origin/review = d66576de952893b17851721fa0d5e9eb6aac85d8`. Batch B — Social Foundations est reviewé, corrigé, promu par fast-forward et validé publiquement ; `main` et `review` sont alignées. Batch A reste également promu. Noël naturel reste à observer en décembre.
