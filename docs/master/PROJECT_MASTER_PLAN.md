...
Version : Chat global player-facing implémenté, reviewé et promu ; validation publique à faire ; MP encore non physique
Date : 2026-09-22
Statut : PREMIER LOT PLAYER-FACING CHAT GLOBAL APPROUVÉ ET PROMU ; TEST PUBLIC PAR AXEL À FAIRE
...
- Le lot player-facing et son prochain contrôle (déploiements puis test public d’Axel) sont décrits dans la première ligne de cette reprise rapide ; ce checkpoint serveur seul constitue désormais son historique.
