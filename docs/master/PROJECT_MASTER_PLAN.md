...
Version : validations publiques Chat/MP et fermeture instantanée de l'éditeur candidate sur review
Date : 2026-09-24
Statut : R894/R897/R515 VALIDÉS PUBLIQUEMENT, MICRO-POLISH ÉDITEUR CANDIDAT
...
- Domaine actif : **micro-polish final de l'éditeur MP puis implémentation candidate du signalement/modération privée R509/R510/R517 sur `review`**.
- Prochaine étape exacte : **review indépendante ChatGPT du micro-polish et du lot signalement MP**. Le signalement devra rester volontaire, snapshoté et limité aux dossiers créés, sans browse libre, sanction ni notification au signalé. Médias, `!mp`, Twitch et Realtime/WebSocket/SSE restent reportés. `PAID_INFRA_APPROVED = false`.
