...
Version : polish public Chat/MP promu sur main, à vérifier au déploiement puis à revalider publiquement
Date : 2026-09-23
Statut : POLISH CHAT/MP SUR MAIN, À VÉRIFICATION DE DÉPLOIEMENT PUIS REVALIDATION PUBLIQUE CIBLÉE
...
- Le lot Chat player-facing reste partiellement validé publiquement : R890, R892, R893 révisée et R894 sont acquises. R891 révisée, R895 révisée et le polish MP R896 attendent leur revalidation publique après vérification du déploiement.
...
- Domaine actif : **polish Chat/MP promu**. Le socle backend/DB et le vertical Chat/MP sont sur `main`. Le cadrage appartient à [l'audit Social R501–R522](../legacy/14-ami-social-audit.md), complété par R883 et R889–R896, sans transfert depuis Event Game C.
- Prochaine étape exacte : **vérification ChatGPT de `main == review`, des déploiements Railway/Cloudflare, de `Application ready`, de `/health` et de la disponibilité frontend**, puis checklist publique ciblée R891 révisée, R895 révisée et MP R896 pour Axel. Les fonctions avancées édition, suppression/restauration, historique complet, recherche/date, signalement/admin MP, médias, `!mp`, Twitch et Realtime/WebSocket/SSE restent reportées. `PAID_INFRA_APPROVED = false`.
