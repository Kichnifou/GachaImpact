...
Version : micro-corrections finales R894/R897 et interactions MP candidates sur review
Date : 2026-09-24
Statut : LOT A CANDIDAT SUR REVIEW, R894/R897 ET MICRO-INTERACTIONS MP À REVALIDER PUBLIQUEMENT
...
- Domaine actif : **publication séquentielle du lot A sur `review`, puis implémentation candidate R515 dans un second commit**, sans promotion `main`.
- Prochaine étape exacte : **terminer les contrôles ciblés du lot A, publier son commit dédié, puis réaliser R515 Historique complet/recherche/date et demander une review indépendante ChatGPT**. Après déploiement ultérieur, Axel revalidera R894/R897 et les nouvelles interactions MP. R891, R895 et R896 ne sont pas rouvertes. Signalement/admin MP, médias, `!mp`, Twitch et Realtime/WebSocket/SSE restent reportés. `PAID_INFRA_APPROVED = false`.
