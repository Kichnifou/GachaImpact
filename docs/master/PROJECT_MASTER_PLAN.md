...
- L’UI affiche identité, mois, résistance, statut, barre PV, preview totale, détails par personnage, bouton Attaquer toujours présent, formation, Top 3, place/contribution personnelle, statistiques lifetime et historique paginé. Le Boss vaincu courant reste dans son bilan ; seuls les mois antérieurs sont archivés. Quotidiennes ajoute sous Combat un sous-indicateur discret de disponibilité/attaque/victoire Boss sans modifier l’état du Combat quotidien.
...
- Le domaine actif reste Combat, désormais centré sur le candidat Boss 0.91. Sa validation publique n’a pas encore eu lieu ; aucun domaine suivant n’est commencé.
