...
La projection personnelle expose thème, fenêtres `PAST | ACTIVE | FUTURE`, index actif, tentatives, succès, possibilité d’essai et cooldown restant. L’UI peut animer localement le décompte, mais seul le serveur autorise une nouvelle tentative. Aucun scheduler, Jeu B/C, R602, Boutique, Collection, Classement, Calendrier, notification Event ou canal chat/Twitch n’est ajouté.
